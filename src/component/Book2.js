...
class Book2 extends Component{
    ...
    doBook=(a)=>{
        ...
        if(sit.length!==0){
                axios.put(API_URL +'/book2/'+this.state.bookID,{
                            id:data.id,
                            nama:data.nama,
                            harga:data.harga,
                            slot:data.slot
    ...
    render(){
        if(this.state.page==="")
        {
            return (
                ...
                <div className="col-xs-4"><img src={image2} width="100%" height="100%" /></div>
                ...
                <div className="table-responsive">
                        <table className="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                          <thead>
                            <tr>
                            <th>Nama Film : </th>
                            <th><center>Batman v Superman: Dawn of Justice</center></th>
                            </tr>
                        </thead>
                        <tbody>
                        <tr>
                            <td>Sinopsis</td>
                            <td>Film ini sangat dinanti2,tetapi tidak bagus</td>
                        </tr>
                        </tbody>
                        <tbody>
                        <tr>
...
export default connect(mapStateToProps)(Book2);